...
Justice gate for sovereign AI decisions.

This service implements the River Rule gate under the iota Verbum modal grammar:

- □ Identity – non-negotiables about who God is and what this schema protects.
- ◇ Enactment – how systems are allowed to act in the domain of justice.
...
- river_rule/      – application code (models, invariants, policy engine, gate, API).
