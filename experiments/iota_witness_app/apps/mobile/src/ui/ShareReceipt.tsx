 ...
 * expo-file-system: uses legacy cacheDirectory + EncodingType (still present in v18).
 * expo-sharing: must be installed separately — add to package.json:
...
export function ShareReceipt({
  ...
  async function handleShare() {
    ...
    try {
      ...
      // FileSystem.cacheDirectory and EncodingType are present in all SDK 54
      // versions of expo-file-system (the new Paths API is additive, not a replacement).
      const cacheDir = FileSystem.cacheDirectory;
      if (!cacheDir) {
        Alert.alert("Storage error", "Unable to access device cache.");
        return;
      }
        ...
        <View style={styles.backdrop}>
          <View style={styles.card}>
            ...
            <Text style={styles.body}>
              The receipt includes the EDEN response, guardrail checks, and verification hashes.
              A spiritual director or counsellor can use it to see exactly what was generated
