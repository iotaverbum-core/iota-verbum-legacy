...
def _format_receipt_datetime(value: datetime) -> str:
    month_year_time = value.strftime("%B %Y, %H:%M UTC")
    return f"{int(value.strftime('%d'))} {month_year_time}"
...
def generate_receipt(
    *,
    ...
    date_display = _format_receipt_datetime(created_at)
