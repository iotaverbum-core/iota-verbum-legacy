...
except Exception:  # pragma: no cover - dependency may be unavailable in minimal envs
    redis = None  # type: ignore[assignment]

from app.narrative_models import NarrativeGraph
...
class NarrativeCache:
    ...
    async def get_graph(self, reference: str, resource_id: str) -> NarrativeGraph | None:
        ...
        if not payload:
            return None
        return NarrativeGraph.model_validate_json(payload)
